...
class Mars(Planet):
    ...
    def __init__(self, groesse = 0.8, rotationswinkel=[1,1],rotationspunkt=[0,0,0], position = [13.5,0,0],rotationsrichtung = [0,0,1],rotationsgeschwindigkeit = [-5,-2], textur = "mars" ):
