...
class Jupiter(Planet):
    ...
    def __init__(self,groesse = 2, rotationswinkel=[100,1],rotationspunkt=[0,0,0], position = [13.5,0,0],rotationsrichtung = [0,0,1],rotationsgeschwindigkeit = [-1.5,-1.5], textur = "jupiter" ):
