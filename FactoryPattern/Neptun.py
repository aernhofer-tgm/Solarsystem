...
class Neptun(Planet):
    ...
    def __init__(self,groesse = 1, rotationswinkel=[1,1],rotationspunkt=[0,0,0], position = [27.5,0,0],rotationsrichtung = [0,0,1],rotationsgeschwindigkeit = [-0.5,-0.5], textur = "neptun" ):
