...
class Saturn(Planet):
    ...
    def __init__(self,groesse = 1.8, rotationswinkel=[1,1],rotationspunkt=[0,0,0], position = [21.5,0,0],rotationsrichtung = [0,0,1],rotationsgeschwindigkeit = [-2,-1.5], textur = "saturn" ):
